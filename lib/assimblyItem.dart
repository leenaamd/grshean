...
class AssemblyItem extends StatefulWidget {
  const AssemblyItem({
    Key? key,
  }) : super(key: key);
...
class _createAssemblyState extends State<AssemblyItem> {
  @override
        ...
        child: ListView(children: <Widget>[
          ...
          Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  enabled: false,
                  hintText: 'غرض هذه الجمعية الادخار',
                  contentPadding: EdgeInsets.fromLTRB(20, 10, 20, 10),
                  focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(100.0),
                      borderSide: const BorderSide(color: Colors.grey)),
          ...
          Container(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                    content: Text('تم انضمامك للجمعية بنجاح'),
                    backgroundColor: Colors.green),
              );
            },
            child: Text('الانضمام للجمعية'),
